...
def bann_text():
    clr()
    logo = """
 ______   ______     ______   __     __  __        ______   __     __    __    
/\  ___\ /\  ___\   /\__  _\ /\ \   /\ \_\ \      /\__  _\ /\ \   /\ "-./  \   
\ \  __\ \ \  __\   \/_/\ \/ \ \ \  \ \  __ \     \/_/\ \/ \ \ \  \ \ \-./\ \  
...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/turk-gladiator/fetihsms.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/turk-gladiator/fetihsms.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("FETİHSMS is up-to-date")
        mesgdcrt.GeneralMessage("Starting FETİHSMS")
...
parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by ‽    ○◘๖ ۣۜ ₲Ⱡ₳Đł₳₮ØⱤ๖ ۣۜ ◘○ !!!')
